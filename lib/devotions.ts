...
export const devotions: Devotion[] = [
  {
    ...
    journalPrompt:
      "What old identity or label have you been holding onto that God wants to replace? Write down 3 truths about who you are in Christ.",
  },
  {
    id: 2,
    ...
    journalPrompt:
      "When was the last time you sat in complete silence before God? Set a timer for 5 minutes today and just listen. Write down anything God puts on your heart.",
  },
  {
    id: 3,
    ...
    journalPrompt:
      "What area of your life requires a step of faith right now? What is holding you back from trusting God fully in this area?",
  },
  {
    id: 4,
    ...
    journalPrompt:
      "Where in your life have you been trying to earn God's approval instead of resting in His grace? How can you extend that same grace to someone else today?",
  },
  {
    id: 5,
    ...
    journalPrompt:
      "Beyond music, what does worship look like in your daily life? Name three ordinary moments today that you can turn into acts of worship.",
  },
  {
    id: 6,
    ...
    journalPrompt:
      "Do you have someone in your life who holds you accountable spiritually? If not, who could you reach out to this week? If yes, how can you deepen that relationship?",
  },
  {
    id: 7,
    ...
    journalPrompt:
      "If you knew you had one year left on earth, what would you change about how you're living? What is stopping you from making those changes now?",
  },
];

export function getTodaysDevotionIndex(): number {
  const now = new Date();
...
export function getTodaysDevotion(): Devotion {
  return devotions[getTodaysDevotionIndex()];
}
