...
const HEART_POSTURES: Record<HeartPosture["type"], HeartPosture> = {
  guilt: {
    ...
    challenge:
      "Are you asking this from a place of guilt? Pastor Johnny often says: guilt tells you that you ARE the mistake, but conviction tells you that you MADE a mistake. God's conviction leads to repentance and freedom — guilt leads to paralysis. Which one are you listening to right now?",
    truthVerse:
  ...
  judgment: {
    ...
    challenge:
      "Let me challenge your heart posture. Are you looking at this situation through a lens of judgment? Pastor Johnny teaches that judgment is often a mirror — the things that frustrate us most in others are often the things God is still working on in us. Before you evaluate someone else's walk, have you honestly examined your own?",
    truthVerse:
  ...
  fear: {
    ...
    challenge:
      "I want to gently ask: is fear at the steering wheel of your heart right now? Pastor Johnny says fear and faith cannot occupy the same seat. Fear says 'what if it goes wrong?' Faith says 'what if God comes through?' The question is not whether your situation is scary — it's whether you believe God is bigger than what scares you.",
    truthVerse:
  ...
  anger: {
    ...
    challenge:
      "Let's talk about your heart posture. Anger is often the bodyguard of pain — it shows up to protect a wound underneath. Pastor Johnny teaches that righteous anger is directed at injustice, but personal anger is often directed at unmet expectations. Which one are you carrying? And more importantly, are you willing to let God underneath the anger to heal what's really there?",
    truthVerse:
  ...
  pride: {
    ...
    challenge:
      "Here's a heart check: are you bringing this to God, or are you bringing it to God after you've already decided what the answer should be? Pastor Johnny warns against 'consulting God' versus 'surrendering to God.' One says 'bless my plan,' the other says 'reveal Your plan.' Which posture is your heart in right now?",
    truthVerse:
  ...
  seeking: {
    ...
    challenge:
      "I can sense that you're coming to this from a genuine place of wanting to grow. That is exactly the heart posture God honors. Pastor Johnny says the difference between a Pharisee and a disciple is that a Pharisee thinks they've arrived, but a disciple knows they're always learning. Keep that hunger. Keep that humility. It is the soil where God plants His deepest truths.",
    truthVerse:
...
const RESPONSE_LIBRARY: ResponseTemplate[] = [
  {
    ...
    wisdom: "Pastor Johnny teaches that anxiety is often the result of carrying tomorrow's weight with today's strength. God did not design you to hold the future — He designed you to hold His hand. The instruction in Philippians is not 'stop worrying' — it's 'start praying.' Replace the worry with a specific prayer. Name it. Give it to God. And then — this is the hard part — leave it there.",
  ...
  },
  {
    ...
    wisdom: "Pastor Johnny often says: 'Doubt your doubts before you doubt your God.' The enemy wants you to interpret God's silence as God's absence. But some of God's most significant work happens in the seasons when you cannot feel Him. Faith is not the absence of fear — it is the decision to trust God in the middle of it. Your fear is not disqualifying you; it's revealing where God wants to meet you next.",
  ...
  },
  {
    ...
    wisdom: "Pastor Johnny teaches that the enemy's strategy is not just to make you sin — it's to make you hide after you sin. Adam's first instinct after the fall was to hide from God. But God came looking for him. He is coming to look for you too. Confession is not about informing God of something He doesn't know — it's about refusing to let shame build a wall between you and your Father. You are not defined by your worst moment. You are defined by the blood that covers it.",
  ...
  },
  {
    ...
    wisdom: "Pastor Johnny says forgiveness is not saying what happened was okay. It's saying what happened will no longer hold you captive. Unforgiveness is like drinking poison and expecting the other person to get sick. God does not ask you to forgive because the other person deserves it — He asks you to forgive because you deserve freedom. This is one of the hardest commands in all of Scripture, and it may not happen in a single moment. But it starts with a decision: 'God, I am choosing to release this person, not because they've earned it, but because You have released me from far worse.'",
  ...
  },
  {
    ...
    wisdom: "Pastor Johnny teaches that loneliness and being alone are two different things. Jesus withdrew to be alone with God regularly — but He was never lonely, because His identity was rooted in the Father's love. Sometimes loneliness is actually a hunger for deeper connection with God that we're trying to fill with people. Other times, it's a genuine need for community that requires us to take a brave step. Either way, God sees you in this season. You are not invisible to Him.",
  ...
  },
  {
    ...
    wisdom: "Pastor Johnny teaches that God does not waste pain. He is close to the brokenhearted — not standing at a distance watching, but right there in the middle of it with you. Jesus wept at the tomb of Lazarus even though He knew He was about to raise him from the dead. Your tears are not weakness — they are proof that you loved well. Grief does not follow a timeline, and anyone who tells you to 'move on' has never truly lost. Give yourself permission to grieve. But also give yourself permission to hope — because the story is not over.",
  ...
  },
  {
    ...
    wisdom: "Pastor Johnny teaches that feelings are real but they are not reliable indicators of God's presence. Elijah performed one of the greatest miracles in the Old Testament on Mount Carmel — and the very next chapter finds him depressed, exhausted, and hiding in a cave. God did not scold him. He fed him, let him rest, and then spoke in a still, small voice. Sometimes God seems silent not because He's absent, but because He's teaching you to listen differently. Keep showing up. Keep opening the Word even when it feels dry. The rain always comes.",
...
function findBestResponse(text: string): ResponseTemplate {
  ...
  if (!bestMatch || bestScore < 3) {
    return {
      ...
      wisdom: "Pastor Johnny teaches that God is not intimidated by your questions, your doubts, or your struggles. He is a Father who invites you to come as you are — not cleaned up, not figured out, but exactly as you are. The invitation of Jesus is not 'get it together and then come.' It is 'come, and I will give you rest.' Whatever you're carrying right now, He can handle it. The question is: will you let Him?",
