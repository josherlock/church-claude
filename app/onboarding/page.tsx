          ...
          <div className="w-full max-w-md mx-auto">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 gap-3">
                {(
                  [
                    { value: "new", label: "I'm new to faith", icon: "🌱" },
                    { value: "growing", label: "I'm growing in my faith", icon: "🌿" },
                    { value: "mature", label: "I'm mature in my faith", icon: "🌳" },
                  ] as const
                ).map((opt) => (
                  <button
                    key={opt.value}
      ...
      <div className="min-h-screen bg-parchment flex flex-col">
        ...
        <div className={`flex-1 flex flex-col items-center justify-center px-6 pb-12 ${transitioning ? "opacity-0" : "fade-in-up"}`}>
          <div className="w-full max-w-lg mx-auto text-center">
            ...
            <div className="mb-6 fade-in-up">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gold/15">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" className="text-gold">
                  <path
                    d="M20 4L23.09 13.26L33 14.27L25.81 20.97L27.82 30.73L20 26.27L12.18 30.73L14.19 20.97L7 14.27L16.91 13.26L20 4Z"
                    fill="currentColor"
                    opacity="0.9"
                  />
                </svg>
            ...
            {/* Selected struggles as tags */}
            <div className="flex flex-wrap justify-center gap-2 mb-8 fade-in-up fade-in-up-delay-2">
              {struggles.map((s) => (
                <span
                  key={s}
                  className="inline-flex items-center gap-1.5 px-4 py-2 bg-gold/10 border border-gold/30 rounded-full text-sm font-medium text-espresso"
                >
